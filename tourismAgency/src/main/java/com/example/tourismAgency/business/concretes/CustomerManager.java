...
public class CustomerManager implements CustomerService{
	...
	public DataResult<GetCustomerResponse> getCustomerById(int id) {
		GetCustomerResponse customerResponse = this.mapperService.forResponse().map(customerRepository.getReferenceById(id), GetCustomerResponse.class);
	...
	public DataResult<List<GetAllCustomerResponse>> getAll() {
		...
		return new SuccessDataResult<List<GetAllCustomerResponse>>(customerResponses, Message.GlobalMessages.DATA_LISTED);
	}
